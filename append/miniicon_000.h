/*
 * Auto-generated from .\miniicon_000.png
 * Original size: 16x16
 * Final size: 16x16
 * Palette: classic
 * Dithering: OFF
 * Color space: lab
 * Variable name: miniicon_000
 * 
...
// 画像サイズ情報
const uint16_t miniicon_000_width = 16;
const uint16_t miniicon_000_height = 16;

// 画像データ配列（1バイトに2ピクセル格納）
const uint8_t miniicon_000_data[128] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB0, 0xBB, 0xBB, 0x0B, 0x00, 0x00,
    0x00, 0x00, 0x0B, 0x00, 0x77, 0xB7, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x70, 0x77, 0xB7, 0x00, 0x00,
    0x00, 0x00, 0x0B, 0x00, 0x77, 0xB7, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x70, 0x77, 0xB7, 0x00, 0x00,
    0x00, 0x00, 0xB0, 0x00, 0x77, 0x0B, 0x00, 0x00, 0x00, 0x00, 0xB0, 0x70, 0x77, 0x0B, 0x00, 0x00,
    0x00, 0x00, 0xB0, 0x00, 0x77, 0x0B, 0x00, 0x00, 0x00, 0x00, 0xB0, 0x70, 0x77, 0x0B, 0x00, 0x00,
...
// 便利なマクロ定義
#define MINIICON_000_WIDTH  16
#define MINIICON_000_HEIGHT 16
#define MINIICON_000_SIZE   128

// 使用例:
// PaletteImageData myImage(miniicon_000_data, miniicon_000_width, miniicon_000_height);
// または
// PaletteImageData myImage(miniicon_000_data, MINIICON_000_WIDTH, MINIICON_000_HEIGHT);
...
// Classic カラーパレット定義
// パレット初期化関数
void miniicon_000_palette_init(RetroColorPalette& palette) {
...
// パレット配列定義（RGB565形式）
const uint16_t miniicon_000_palette[16] = {
