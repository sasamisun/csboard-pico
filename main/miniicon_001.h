/*
 * Auto-generated from .\miniicon_001.png
 * Original size: 16x16
 * Final size: 16x16
 * Palette: classic
 * Dithering: OFF
 * Color space: lab
 * Variable name: miniicon_001
 * 
...
// 画像サイズ情報
const uint16_t miniicon_001_width = 16;
const uint16_t miniicon_001_height = 16;

// 画像データ配列（1バイトに2ピクセル格納）
const uint8_t miniicon_001_data[128] = {
    
};

// 便利なマクロ定義
#define MINIICON_001_WIDTH  16
#define MINIICON_001_HEIGHT 16
#define MINIICON_001_SIZE   128

// 使用例:
// PaletteImageData myImage(miniicon_001_data, miniicon_001_width, miniicon_001_height);
// または
// PaletteImageData myImage(miniicon_001_data, MINIICON_001_WIDTH, MINIICON_001_HEIGHT);
...
// Classic カラーパレット定義
// パレット初期化関数
void miniicon_001_palette_init(RetroColorPalette& palette) {
...
// パレット配列定義（RGB565形式）
const uint16_t miniicon_001_palette[16] = {
